...
import (
	...
	"github.com/pirateXXOO/memrizr/account/model/mocks"
...
func TestSignup(t *testing.T) {
	...
	t.Run("Email and Password Required", func(t *testing.T) {
		...
		mockUserService.On("Signup", mock.AnythingOfType("*gin.Context"), mock.
			AnythingOfType("*model.User")).Return(nil)

		// a response recorder for getting written http response
		rr := httptest.NewRecorder()

		// don't need a middle ware as we don't yet have authorized user
		router := gin.Default()
	...
	t.Run("Password too long", func(t *testing.T) {
		...
		reqBody, err := json.Marshal(gin.H{
			"email":    "bob@bob.com",
			"password": "sujfoejojfoijoiwjefojwoiejfiowjoiejfoijwoiejfoejfoiewjoifejiowjfoiejoifjowiejfiowjifjwioefjiojwfiwpe",
		})
		assert.NoError(t, err)
